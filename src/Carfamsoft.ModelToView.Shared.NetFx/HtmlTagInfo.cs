...
namespace Carfamsoft.ModelToView.Shared
{
    ...
    public static class HtmlTagInfo
    {
        ...
        /// <returns></returns>
        public static bool IsSelfClosing(string tagName) => SelfClosingTagNames.ContainsNoCase(tagName);
        ...
        /// <param name="tagName">The name of the HTML tag.</param>
        /// <returns></returns>
        public static bool HasTypeAttribute(string tagName) => TagsWithTypeAttribute.ContainsNoCase(tagName);
